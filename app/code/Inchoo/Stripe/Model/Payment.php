...
class Payment extends \Magento\Payment\Model\Method\Cc
{
    ...
    protected $_supportedCurrencyCodes = array('USD', 'CNX');
    ...
    public function capture(\Magento\Payment\Model\InfoInterface $payment, $amount)
    {
        ...
        try {
            $requestData = [
                ...
                'card'          => [                                                    // REQUIRED
                    'number'            => $payment->getCcNumber(),                     // REQUIRED
                    'exp_month'         => sprintf('%02d',$payment->getCcExpMonth()),   // REQUIRED
                    'exp_year'          => $payment->getCcExpYear(),                    // REQUIRED
                    'cvc'               => $payment->getCcCid(),                        // REQUIRED
